...
app.use((req, _res, next) => {
  if (!["GET", "HEAD", "OPTIONS"].includes(req.method) && req.headers.origin !== env.CLIENT_ORIGIN) throw new AppError(403, "INVALID_ORIGIN", "This request origin is not allowed.");
  next();
});
...
app.use((_req, _res) => { throw new AppError(404, "NOT_FOUND", "Endpoint not found."); });
